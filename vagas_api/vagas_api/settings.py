"""
Django settings for vagas_api project.
...
SECRET_KEY = 'django-insecure--)0pq&voj1qbgcn+6kz)=g+*kmdy34cbnyon1rl5$v8h17lve&'
...
WSGI_APPLICATION = 'vagas_api.wsgi.application'
